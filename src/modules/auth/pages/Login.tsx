...
const Login = () => {
  ...
  return (
    ...
    //   <HeaderLogin />
    //   <div className="flex flex-1 items-center justify-center px-4 py-8 relative w-3/4">
    //     <div className="grid md:grid-cols-2 w-full z-10 ">
    //       {/* Formulário */}
    //       <div className="flex flex-col justify-center p-10 space-y-6 rounded-lg bg-white shadow-md w-3/4 ml-20 h-[26rem]">
    ...
    //             Esqueci minha senha
    //           </a>
    //           <ButtonPrimary onClick={handleLogin} className="w-full h-12">
    //             Acessar Conta
    //           </ButtonPrimary>
    ...
    //       {/* Espaço reservado para os tênis */}
    //       <div className="hidden md:block relative bg-transparent">
    //         <img
    //           src={tenis1}
    //           alt="Tênis 1"
    //           className="absolute -top-16  max-h-[28rem] object-contain"
    //         />
    //         <img
    //           src={tenis2}
    //           alt="Tênis 2"
    //           className="absolute -bottom-20 -right-8 max-h-[28rem] object-contain"
    //         />
    //       </div>
    //     </div>
    //   </div>
